...
import header_halloween_image from "./header_halloween_image.png";
import header_animal_image from "./header_animal_image.png";
import bat_superhero_costume from "./bat_superhero_costume.png";
import Superman_costume from "./Superman_costume.png"
import classical from "./classical.png";
import ghost from "./ghost.png";
import tiger from "./tiger.png";
import Poster_halloween from "./Poster_halloween.png";
import animal_birds_poster from "./animal_birds_poster.png";
import indian_state_poster from "./indian_state_poster.png";
import fairytale_poster from "./fairytale_poster.png";
import Sports_poster from "./Sports_poster.png";
import History from "./History.png";
import service_poster from "./service_poster.png";
import superhero_poster from "./superhero_poster.png";
...
export const assets = {
  ...
  bat_superhero_costume,
  header_halloween_image,
  History,
  header_animal_image,
  macbook_image,
...
export const productsDummyData = [
  {
    ...
    "name": "Bat-Man costume",
    "description": "Transform into the legendary Dark Knight with this premium Batman-inspired fancy dress costume. Designed with high-quality materials and realistic detailing, it's perfect for costume parties, comic conventions, school events, themed celebrations, cosplay, and photoshoots. Comfortable to wear and crafted for an impressive look, this costume lets you embody the fearless masked hero while standing out at any event.",
    "price": 499.99,
    "offerPrice": 399.99,
    "image": [
      assets.bat_superhero_costume
    ],
    "category": "Superhero",
    "date": 1738667236865,
    "__v": 0
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "Superman_costume",
    "description": "Become the iconic Man of Steel with this premium Superman-inspired fancy dress costume. Featuring vibrant colors, detailed craftsmanship, and a comfortable fit, it's perfect for costume parties, school events, superhero-themed celebrations, cosplay, and photoshoots. Designed for both style and comfort, this costume helps you capture the look of a legendary hero and make a powerful impression wherever you go.",
    "price": 429.99,
    "offerPrice": 329.99,
    "image": [
      assets.Superman_costume
    ],
    "category": "Headphone",
    "date": 1738667310300,
    "__v": 0
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "classical_dress",
    "description": "Celebrate India's rich cultural heritage with this beautifully crafted classical fancy dress costume. Designed with elegant traditional details, premium fabrics, and a comfortable fit, it's perfect for school functions, cultural events, stage performances, festive celebrations, and competitions. This costume offers an authentic and graceful look, helping you showcase timeless tradition with confidence and style.",
    "price": 899.99,
    "offerPrice": 799.99,
    "image": [
      assets.classical
  ...
  },
  {
    ...
    "userId": "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    "name": "ghost",
    "description": "Create a spooky and unforgettable look with this premium Ghost fancy dress costume. Designed with eerie details, lightweight materials, and a comfortable fit, it's perfect for Halloween, costume parties, school events, themed celebrations, and stage performances. Easy to wear and crafted for a haunting appearance, this costume is sure to make you stand out at any event.",
    "price": 399.99,
    "offerPrice": 349.99,
    "image": [
        assets.ghost
